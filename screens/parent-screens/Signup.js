...
import {login, loginAsParent, registerAsParent} from '../../redux/actions/auth';
import {colors, fonts} from '../../constants/theme';
import {Button} from 'react-native-paper';

const Signup = ({login, registerAsParent, navigation}) => {
...
export default connect(null, {login, registerAsParent})(Signup);
